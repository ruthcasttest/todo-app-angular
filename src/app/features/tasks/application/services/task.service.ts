...
import { AuthState } from "../../../auth/application/state/auth.state";
import { CreateTaskRequest, Task, UpdateTaskRequest } from "../../domain/models/task.model";
import { TaskRepositoryPort } from "../../domain/ports/task.repository.port";
import { TasksState } from "../state/tasks.state";

@Injectable({ providedIn: "root" })
export class TaskService {
    private readonly taskRepository = inject(TaskRepositoryPort);
    ...
    loadTasks(): Observable<Task[]> {
        ...
        return this.taskRepository.getTasks(userId).pipe(
    ...
    createTask(title: string, description: string): Observable<Task> {
        ...
        return this.taskRepository.createTask(request).pipe(
    ...
    updateTask(request: UpdateTaskRequest): Observable<Task> {
        ...
        return this.taskRepository.updateTask(request).pipe(
